        ...
        <div className="p-4 bg-white/[0.02]">
          ...
          <div className="mt-6 flex gap-3 justify-end">
            ...
            <button 
              ...
              className="px-6 py-2 bg-cyan-500 hover:bg-cyan-600 text-white font-semibold rounded-xl transition-colors shadow-[0_0_15px_rgba(6,182,212,0.3)] flex items-center gap-2"
            >
              <Check size={18} /> Apply
            </button>
          </div>
