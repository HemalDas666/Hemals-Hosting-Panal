...
export default function ServerConsole({ serverId, server }: { serverId: string, server?: any }) {
  ...
  return (
    <div className="flex flex-col flex-1 bg-[#0a0a0c] h-full min-h-[400px] md:min-h-0">
      <div className="flex flex-col flex-1 bg-[#050505] border-b border-white/5 overflow-hidden min-h-0 shadow-2xl relative">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/5 shrink-0 border-b border-white/5">
